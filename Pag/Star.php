                            ...
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">
                                    <a class="navbar-brand" href="#">
                                        <img src="../img/Logo.jpeg" alt="logo" width="40px" style="border-radius: 100%;">
                                    </a>
                                </font>
                            </font>
                        </a>
                    ...
                    <div class="container" id="contenedor" style="width: 90%;">
                        ...
                        if ($result->num_rows > 0) { ?>
                            <div class="row" style=" border-radius: 8px; padding: 5px;">
                                <div class="col-md-6">
                                    <b>
                                        <h3 style="Color:#FFD9DE"> Titulo</h3>
                                    </b>
                                </div>
                                <div class="col-md-6">
                                    <b>
                                        <h3 style="Color:#FFD9DE"> Visitas</h3>
                                    </b>
                                </div>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                if ($cont == 0) {
                                    $cont++; ?>
                                    <div class="vis">
                                        <div class="row d-flex justify-content-center align-items-center" style="margin: 5%;">
                                            <div class="col-md-10">
                                                <a href="../php/visitas.php?id=<?php echo $row['id'] ?>" target="_blank" style="text-decoration: none; color: #000; font-size: 12px;">
                                                    <b><?php echo $row['Titulo'] ?></b> </a>
                                            </div>
                                            <div class="col-md-2">
                                                <p style="font-size: 16px;"><?php echo $row['Visitas'] ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                <?php } else {
                                    ...
                                    <div class="vis">
                                        <div class="row d-flex justify-content-center align-items-center" style="margin: 5%;" >
                                            ...
                                            <div class="col-md-2">
                                                <p style="font-size: 16px; margin:auto;"><?php echo $row['Visitas'] ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
